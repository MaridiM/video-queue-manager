      ...
      <aside className="w-64 bg-slate-900 text-white hidden md:flex flex-col fixed inset-y-0 left-0 z-10">
        <div className="p-6 border-b border-slate-800">
          <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
            <div className="w-8 h-8 bg-blue-600 rounded-md flex items-center justify-center">Q</div>
            QueueMgr
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1">
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${currentView === 'dashboard' ? 'bg-blue-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${currentView === 'queue' ? 'bg-blue-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`}
          >
            <ListVideo size={20} />
            Video Queue
          </button>
